...
class ProgramacaoViewController: UIViewController {
    // MARK: Declarações
    @IBOutlet weak var timerView: UIView!
    @IBOutlet weak var questionLabel: UILabel!
    @IBOutlet var answersButton: [UIButton]!
    
    var programacaoManager = ProgramacaoManager()
    ...
    func getNewQuiz(){
        programacaoManager.refreshQuiz()
        
        // MARK: implementando botões
        questionLabel.text = programacaoManager.question
        for i in 0..<programacaoManager.options.count {
            let option = programacaoManager.options[i]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        resultViewController.totalAnswers = programacaoManager.totalAnswers
        resultViewController.totalCorrectedAnswers = programacaoManager.totalCorrectAnswers
    }
    ...
    @IBAction func selectAnswer(_ sender: UIButton) {
        ...
        programacaoManager.validateAnswer(index: index)
